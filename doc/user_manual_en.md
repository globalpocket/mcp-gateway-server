...
Controls which tools are presented to the AI and how they are routed. The default file is a minimal `{ "version": "0.2.2" }`. The following is an **example** of how to define advanced rules:
